                ...
                Forgot Password
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newpass">Forgot Password</button>
                            </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="modal fade" id="newpass" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#">Change</button>
                            </div>
                            </div>
                        </div>
                        </div>
