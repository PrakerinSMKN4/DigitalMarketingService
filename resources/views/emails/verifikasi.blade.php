...
<head>
    ...
    <title>Email</title>
    <style>
      .btn{display:inline-block;font-weight:400;color:#fff;background-color:#28a745;border-color:#28a745;text-align:center;vertical-align:middle;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;;border:1px solid transparent;padding:.375rem .75rem;font-size:1rem;line-height:1.5;border-radius:.25rem;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out}@media (prefers-reduced-motion:reduce){.btn{transition:none}};
...
<body>
  <center>
    <div class="card text-center">
      <div class="card-header" style="background: lightgray; padding: 25px;">
      ...
      <div class="card-footer text-muted" style="background: lightgray; margin-top: 30px; padding: 25px;">
      {{ date("d F Y") }}
      </div>
    </div>
  </center>
