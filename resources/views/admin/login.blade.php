...
<body style="background: #36395a;">
    <div class="row h-100 w-100">
        <div class="container my-auto" style="text-align: center;">
            ...
            <div class="row">
                {{-- Vector, Etc --}}
                <div class="col-md-8 rounded-left" style="background: #f6af09;">
                    <img src="{{asset('/assets/default/3972337.png')}}" class="img-fluid p-5">
                </div>

                {{--Login Forms--}}
                <div class="col rounded-right p-5" style="background: #ffffff;">
                    ...
                    <div class="mt-4">
                        ...
                        {{-- Google Sign In --}}
                        <button type="button" class="btn btn-transparant" data-toggle="modal"
